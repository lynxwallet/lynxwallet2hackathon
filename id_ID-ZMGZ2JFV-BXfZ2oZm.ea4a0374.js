var a,e;"function"==typeof(a=globalThis.define)&&(e=a,a=null),function(e,n,t,i,s){var d="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},k="function"==typeof d[i]&&d[i],u=k.cache||{},p="undefined"!=typeof module&&"function"==typeof module.require&&module.require.bind(module);function r(a,n){if(!u[a]){if(!e[a]){var t="function"==typeof d[i]&&d[i];if(!n&&t)return t(a,!0);if(k)return k(a,!0);if(p&&"string"==typeof a)return p(a);var s=Error("Cannot find module '"+a+"'");throw s.code="MODULE_NOT_FOUND",s}m.resolve=function(n){var t=e[a][1][n];return null!=t?t:n},m.cache={};var l=u[a]=new r.Module(a);e[a][0].call(l.exports,m,l,l.exports,this)}return u[a].exports;function m(a){var e=m.resolve(a);return!1===e?{}:r(e)}}r.isParcelRequire=!0,r.Module=function(a){this.id=a,this.bundle=r,this.exports={}},r.modules=e,r.cache=u,r.parent=k,r.register=function(a,n){e[a]=[function(a,e){e.exports=n},{}]},Object.defineProperty(r,"root",{get:function(){return d[i]}}),d[i]=r;for(var l=0;l<n.length;l++)r(n[l]);if(t){var m=r(t);"object"==typeof exports&&"undefined"!=typeof module?module.exports=m:"function"==typeof a&&a.amd?a(function(){return m}):s&&(this[s]=m)}}({dTibp:[function(a,e,n){var t=a("@parcel/transformer-js/src/esmodule-helpers.js");t.defineInteropFlag(n),t.export(n,"default",()=>i);var i=`{
  "connect_wallet": {
